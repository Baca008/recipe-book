...
const DEFAULT_RECIPES = [
  ...
  {
    id: "demo-44",
    name: "Hot and Sour Soup (Woks of Life)",
    category: "Dinner",
    servings: 6,
    prepTime: "1 hr (incl. soaking)",
    cookTime: "20 min",
    favorite: false,
    ingredients: [
      { amount: 4, unit: "oz", name: "pork shoulder, finely julienned (or skip for vegetarian)" },
      { amount: 1, unit: "tbsp", name: "water (for pork marinade)" },
      { amount: 1, unit: "tsp", name: "cornstarch (for pork marinade)" },
      { amount: 2, unit: "tsp", name: "neutral oil (for pork marinade)" },
      { amount: 8, unit: "cup", name: "low-sodium chicken stock (homemade broth is best here)" },
      { amount: 0.3, unit: "oz", name: "dried lily flowers, rehydrated (about ½ cup after soaking)" },
      { amount: 0.3, unit: "oz", name: "dried wood ear mushrooms, rehydrated and roughly chopped (about ½ cup)" },
      { amount: 0.3, unit: "oz", name: "dried shiitake mushrooms, rehydrated and thinly sliced (about ½ cup)" },
      { amount: 3, unit: "oz", name: "spiced dry tofu (wu xiang dougan), cut into 2-inch x ¼-inch strips" },
      { amount: 4, unit: "oz", name: "fresh firm tofu, cut into 2-inch x ¼-inch strips" },
      { amount: 4, unit: "oz", name: "bamboo shoots, julienned" },
      { amount: 1, unit: "tbsp", name: "light soy sauce (or seasoned soy sauce)" },
      { amount: 2, unit: "tsp", name: "dark soy sauce (or mushroom soy sauce)" },
      { amount: 0.5, unit: "tsp", name: "salt, or to taste" },
      { amount: 0.25, unit: "tsp", name: "sugar" },
      { amount: 1.5, unit: "tsp", name: "white pepper, freshly ground — or more to taste (this is the heat)" },
      { amount: 1, unit: "tsp", name: "sesame oil" },
      { amount: 0.33, unit: "cup", name: "white vinegar — start here, add more to taste (this is the sour)" },
      { amount: 1, unit: "", name: "dried red chili pepper, seeds removed and minced (optional)" },
      { amount: 0.33, unit: "cup", name: "cornstarch (for slurry)" },
      { amount: 0.25, unit: "cup", name: "water (for slurry)" },
      { amount: 1, unit: "", name: "large egg, beaten" },
      { amount: 2, unit: "", name: "scallions, finely diced (for garnish)" },
    ],
    steps: [
      "Marinate pork: Combine julienned pork with 1 tbsp water, mixing until absorbed. Add a pinch of salt, 2 tsp oil, and 1 tsp cornstarch. Mix well and set aside.",
      "Rehydrate dry ingredients: Soak lily flowers, wood ear mushrooms, and shiitake mushrooms in separate bowls of hot water (like brewing tea) for 1–2 hours or until fully hydrated. Once soft, thinly slice the shiitakes, roughly chop the wood ears, and trim the tough ends off lily flowers then cut in half. If using dried chili pepper, remove seeds and mince.",
      "Prep remaining ingredients: Cut both tofu varieties into 2-inch long x ¼-inch thick strips. Julienne the bamboo shoots. Beat the egg. Dice the scallions.",
      "Build the soup: Bring chicken stock to a boil in a wok or large pot. Stir in the marinated pork, quickly breaking up any clumps. Once simmering again, skim off any foam from the surface.",
      "Season: Add salt, sugar, white pepper, both soy sauces, sesame oil, and minced chili if using. Then add lily flowers, wood ears, shiitake mushrooms, and bamboo shoots. Bring back to a simmer.",
      "Add tofu and vinegar: Add both types of tofu and the white vinegar. Stir and taste — it should start to look and smell like the real thing. Adjust vinegar and white pepper to your preference.",
      "Thicken: Mix cornstarch slurry well (it settles fast). Use your ladle to stir the soup in a steady circular motion making a whirlpool, then slowly drizzle in ¾ of the slurry. Keep stirring until soup returns to a simmer and coats the back of a spoon. Add remaining slurry if you want it thicker.",
      "Egg ribbons: Keep soup at a steady simmer (must be bubbling or egg turns cloudy). Stir in a circular motion with the ladle to create a whirlpool, then slowly drizzle the beaten egg in a thin stream into the moving soup. The motion creates delicate ribbons.",
      "Serve immediately garnished with diced scallions. Add extra white pepper or vinegar at the table to taste.",
    ],
    notes: "Recipe adapted from Woks of Life family restaurant recipe.\n\nThe two controls: WHITE PEPPER = heat, WHITE VINEGAR = sour. The Woks of Life recipe uses ranges (1–2 tsp pepper, ⅓–½ cup vinegar) so you can dial in your own balance. Start conservative and add at the table.\n\nSPICED DRY TOFU (wu xiang dougan) is the authentic ingredient — firm, pre-seasoned five-spice tofu in a brown block. Find at H-Mart in the tofu refrigerator section. Regular firm tofu alone works but the spiced tofu adds a unique savory depth.\n\nLILY FLOWERS must have tough ends trimmed. WOOD EARS need a rough chop after rehydrating. Both at H-Mart dried goods aisle.\n\nUSE YOUR HOMEMADE CHICKEN BROTH here — Woks of Life specifically calls for good stock and notes it makes a significant difference.\n\nKEEP SOUP BUBBLING before adding egg — if the soup isn't at a proper simmer when you add the egg, it turns the soup cloudy instead of forming ribbons.\n\nVEGETARIAN: Skip the pork, use vegetable broth, keep the egg (or skip for vegan). The tofu and mushroom combination still delivers great depth.",
  },
  {
    id: "demo-45",
  ...
  },
  {
    ...
    favorite: false,
    ingredients: [
      { amount: 4, unit: "piece", name: "bone-in skin-on chicken thighs (or 1 whole chicken, 3-4 lb)" },
      { amount: 6, unit: "cup", name: "water (enough to cover the chicken)" },
      { amount: 4, unit: "slice", name: "fresh ginger, smashed" },
      { amount: 3, unit: "clove", name: "garlic, smashed" },
      { amount: 3, unit: "piece", name: "scallions, whole" },
      { amount: 1, unit: "tsp", name: "salt" },
      { amount: 2, unit: "cup", name: "jasmine rice, rinsed" },
      { amount: 2, unit: "tbsp", name: "chicken fat or schmaltz (or neutral oil)" },
      { amount: 3, unit: "clove", name: "garlic, minced (for rice)" },
      { amount: 1, unit: "slice", name: "ginger, minced (for rice)" },
      { amount: 2, unit: "cup", name: "reserved poaching stock (for cooking rice)" },
      { amount: 3, unit: "tbsp", name: "fresh ginger, grated (for ginger-scallion sauce)" },
      { amount: 4, unit: "piece", name: "scallions, thinly sliced (for ginger-scallion sauce)" },
      { amount: 3, unit: "tbsp", name: "neutral oil, hot (for ginger-scallion sauce)" },
      { amount: 0.5, unit: "tsp", name: "salt (for ginger-scallion sauce)" },
      { amount: 3, unit: "tbsp", name: "soy sauce" },
      { amount: 1, unit: "tbsp", name: "dark soy sauce" },
      { amount: 1, unit: "tsp", name: "sesame oil" },
      { amount: 1, unit: "tsp", name: "sugar" },
      { amount: 0.5, unit: "cup", name: "cucumber, sliced (for serving)" },
      { amount: 0.25, unit: "cup", name: "cilantro (for serving)" },
    ],
    steps: [
      "Bring the water to a boil in a large pot with the smashed ginger, smashed garlic, whole scallions, and salt.",
      "Lower the chicken thighs (or whole chicken) into the pot, skin side down. The water should just cover the chicken; top up if needed.",
      "Bring back to a gentle simmer (not a rolling boil), then cover and poach for 20-25 minutes for thighs, or 35-40 minutes for a whole chicken, until just cooked through (165°F internal).",
      "Remove the chicken and immediately plunge into a bowl of ice water for 5-10 minutes — this tightens the skin and stops the cooking. Reserve the poaching stock.",
      "Once cooled, pat the chicken dry, rub the skin lightly with sesame oil, and set aside. Debone if desired, then slice or chop into serving pieces.",
      "For the rice: heat the chicken fat or oil in a pan over medium heat. Add minced garlic and ginger and cook until fragrant, about 1 minute.",
      "Add the rinsed rice and stir to coat every grain in the fat, toasting for 1-2 minutes.",
      "Transfer the rice to the rice cooker, add 2 cups of the reserved poaching stock (strained), and cook on the white rice setting.",
      "For the ginger-scallion sauce: combine the grated ginger, sliced scallions, and salt in a heatproof bowl. Pour the hot oil over the top and stir to combine.",
      "For the dipping sauce: whisk together the soy sauce, dark soy sauce, sesame oil, and sugar with 2 tablespoons of the poaching stock.",
      "Serve the sliced chicken over the cooked rice with cucumber slices and cilantro, alongside the ginger-scallion sauce and soy dipping sauce. Sip the remaining poaching stock as a light soup on the side, garnished with scallions.",
    ],
    notes: "ZOJIRUSHI RICE COOKER\nUse the white rice setting and the 2:2 rice-to-stock ratio above. If your cooker has a \"congee\" or \"quick\" mode, avoid it here — the standard white rice cycle gives the best texture for this dish.\n\nCHICKEN CHOICE\nTraditional Hainanese chicken rice uses a whole chicken poached and served on the bone for presentation, but bone-in skin-on thighs (your usual H-Mart pickup) work well and poach faster. If deboning first, save the bones and any trimmed fat for the poaching stock and future schmaltz batches — see the schmaltz notes in other chicken recipes in this book.\n\nSOURCING\nJasmine rice, dark soy sauce, and fresh ginger are all easy finds at H-Mart or 99 Ranch. Dark soy sauce is thicker and more caramel-like than regular soy sauce; if you don't have it, substitute regular soy sauce plus a pinch more sugar for color and depth.\n\nGINGER-SCALLION SAUCE\nThis sauce is essential to the dish — don't skip it. It also keeps well in the fridge for a few days and is great spooned over any poached or steamed protein, or stirred into plain rice or noodles.\n\nMAKE-AHEAD\nThe poaching stock can be made a day ahead and refrigerated; the fat that solidifies on top can be skimmed off and used as the chicken fat for the rice step, saving a trip for schmaltz.\n\nSOUS VIDE VARIATION\nDebone the thighs first (as usual) and save the bones and trimmings for stock. Season the deboned meat with salt, seal in a bag with the smashed ginger and garlic, and cook at 150 degrees F (65.5 degrees C) for 1.5-2 hours. Meanwhile, simmer the reserved bones with the ginger, garlic, and scallions called for in the poaching step to make the stock for cooking the rice, since sous vide won't produce a poaching liquid on its own. After the bath, pat the chicken dry and sear skin-side down in a hot pan for 60-90 seconds to crisp the skin before slicing and serving.",
  },
  {
    id: "demo-49",
    name: "Braised Eggplant with Ground Pork and Black Bean Sauce",
    category: "Dinner",
    servings: 4,
    prepTime: "15 min",
    cookTime: "20 min",
    favorite: false,
    ingredients: [
      { amount: 3, unit: "piece", name: "Chinese (long) eggplants, cut into batons" },
      { amount: 0.5, unit: "lb", name: "ground pork" },
      { amount: 2, unit: "tbsp", name: "fermented black beans, rinsed and roughly chopped (or black bean garlic sauce)" },
      { amount: 4, unit: "clove", name: "garlic, minced" },
      { amount: 1, unit: "tbsp", name: "ginger, minced" },
      { amount: 2, unit: "piece", name: "scallions, sliced (white and green separated)" },
      { amount: 1, unit: "piece", name: "fresh red chili or dried chili, sliced (optional)" },
      { amount: 2, unit: "tbsp", name: "soy sauce" },
      { amount: 1, unit: "tbsp", name: "oyster sauce" },
      { amount: 1, unit: "tbsp", name: "Shaoxing wine" },
      { amount: 1, unit: "tsp", name: "sugar" },
      { amount: 0.75, unit: "cup", name: "chicken stock or water" },
      { amount: 1, unit: "tsp", name: "cornstarch" },
      { amount: 2, unit: "tbsp", name: "water (for cornstarch slurry)" },
      { amount: 3, unit: "tbsp", name: "neutral oil, divided" },
      { amount: 1, unit: "tsp", name: "sesame oil" },
    ],
    steps: [
      "Cut the eggplant into 2-3 inch batons. Optional: salt lightly and let sit 10 minutes to draw out moisture, then pat dry.",
      "Heat 2 tablespoons of oil in a wok or large skillet over high heat. Fry the eggplant in batches until lightly browned and softened, 3-4 minutes per batch. Remove and set aside.",
      "Add the remaining tablespoon of oil to the pan. Add the ground pork and break it up, cooking until browned, about 3-4 minutes.",
      "Add the garlic, ginger, scallion whites, and chili (if using). Stir-fry until fragrant, about 30 seconds.",
      "Add the chopped fermented black beans and stir-fry another 30 seconds to release their aroma.",
      "Stir in the soy sauce, oyster sauce, Shaoxing wine, sugar, and chicken stock. Bring to a simmer.",
      "Return the eggplant to the pan and toss to coat. Cover and braise for 4-5 minutes, until the eggplant is fully tender.",
      "Mix the cornstarch with 2 tablespoons of water and stir into the pan. Simmer until the sauce thickens and coats the eggplant, about 1 minute.",
      "Drizzle with sesame oil, scatter scallion greens on top, and serve immediately over rice.",
    ],
    notes: "SOURCING\nChinese (long) eggplant, fermented black beans (douchi), and Shaoxing wine are all easy finds at H-Mart or 99 Ranch. Fermented black beans have a strong, salty, funky flavor — a little goes a long way, so rinse them briefly before chopping to soften the intensity. Black bean garlic sauce (jarred) is a fine substitute if you don't want to keep whole fermented beans on hand.\n\nEGGPLANT TEXTURE\nSalting the eggplant briefly before frying helps it brown rather than steam, and reduces how much oil it soaks up. If you're short on time, skip the salting step — the dish will still work, just slightly softer and more oil-absorbent.\n\nVEGETARIAN VARIATION\nOmit the ground pork and use a splash more oil for the aromatics; the black bean sauce carries plenty of flavor on its own. Diced shiitake mushrooms are a good substitute for the pork's texture.\n\nAIR FRYER SHORTCUT\nInstead of pan-frying the eggplant in oil, toss the batons lightly in oil and air fry in the Breville Smart Oven Air Fryer at 400°F for 10-12 minutes, flipping halfway, until browned and softened. Then proceed with the sauce and braising steps as written.",
  },
  {
    id: "demo-50",
    ...
    favorite: false,
    ingredients: [
      { amount: 2, unit: "piece", name: "large globe eggplants, sliced into 1/2-inch rounds" },
      { amount: 1, unit: "tsp", name: "salt (for sweating the eggplant)" },
      { amount: 0.5, unit: "cup", name: "all-purpose flour" },
      { amount: 2, unit: "piece", name: "large eggs, beaten" },
      { amount: 1.5, unit: "cup", name: "panko breadcrumbs" },
      { amount: 0.5, unit: "cup", name: "grated parmesan (for breading)" },
      { amount: 1, unit: "tsp", name: "dried oregano" },
      { amount: 3, unit: "cup", name: "marinara sauce (jarred or homemade)" },
      { amount: 2, unit: "cup", name: "shredded mozzarella" },
      { amount: 0.25, unit: "cup", name: "grated parmesan (for topping)" },
      { amount: 0.25, unit: "cup", name: "fresh basil leaves, torn" },
      { amount: 3, unit: "tbsp", name: "olive oil (for spraying/brushing)" },
    ],
    steps: [
      "Lay the eggplant rounds on a wire rack or paper towels, salt both sides, and let sit for 20-30 minutes to draw out moisture and bitterness. Pat dry.",
      "Set up a breading station: flour in one bowl, beaten eggs in a second, and panko mixed with parmesan and oregano in a third.",
      "Dredge each eggplant round in flour, then egg, then the panko mixture, pressing to adhere.",
      "Preheat the oven to 400°F (200°C). Arrange the breaded rounds on a baking sheet lined with parchment and lightly brush or spray with olive oil.",
      "Bake for 20-25 minutes, flipping halfway, until golden and crisp.",
      "Spread a thin layer of marinara in the bottom of a baking dish. Layer the baked eggplant rounds, more marinara, and a scattering of mozzarella, repeating until all the eggplant is used, finishing with sauce and cheese on top.",
      "Sprinkle the remaining parmesan over the top and bake for 15-20 minutes, until the cheese is melted and bubbling.",
      "Let rest 5-10 minutes before serving, topped with torn fresh basil.",
    ],
    notes: "AIR FRYER SHORTCUT\nInstead of oven-baking the breaded rounds, arrange them in a single layer in the Breville Smart Oven Air Fryer basket and air fry at 380°F for 10-12 minutes, flipping halfway, until golden and crisp. This gets closer to a fried texture with much less oil, and works well in batches if the eggplant doesn't all fit at once.\n\nEGGPLANT PREP\nSalting and drying the eggplant before breading is the key step — skipping it leads to a soggier bake since raw eggplant holds a lot of water. Letting it sit closer to 30 minutes gives the best results.\n\nMAKE-AHEAD\nThe breaded and baked eggplant rounds can be made a day ahead and refrigerated; assemble and do the final bake just before serving. The fully assembled bake also reheats well the next day.\n\nNOTE\nThis one leans more Italian-American than the rest of the book's usual repertoire, but it's a solid crowd-pleaser and a good way to use up extra globe eggplant.",
  },
  {
    id: "demo-51",
    name: "Padakjeon (Korean Chicken Pancake)",
    category: "Snack",
    servings: 2,
    prepTime: "15 min",
    cookTime: "12 min",
    favorite: false,
    ingredients: [
      { amount: 300, unit: "g", name: "boneless chicken thighs, cut into small bite-size pieces" },
      { amount: 2, unit: "", name: "scallions, thinly sliced lengthwise into curls" },
      { amount: 5, unit: "tbsp", name: "cornstarch" },
      { amount: 4, unit: "tbsp", name: "cold water" },
      { amount: 0.5, unit: "tsp", name: "garlic powder" },
      { amount: 0.5, unit: "tsp", name: "salt" },
      ...
      { amount: 1, unit: "tsp", name: "toasted sesame oil" },
      { amount: 0.5, unit: "tsp", name: "gochugaru or chili flakes" },
      { amount: 1, unit: "", name: "garlic clove, minced" },
    ],
    steps: [
      "In a bowl, combine the chicken, cornstarch, garlic powder, salt, and pepper. Add the cold water a little at a time, stirring until you get a thick, cohesive batter that coats the chicken evenly.",
      "Heat the oil in a nonstick skillet over medium heat. Pour in the chicken mixture and spread it into an even, thin layer to form one large pancake.",
      "Cook undisturbed for about 7 minutes until deep golden and crisp on the bottom, lowering the heat if it's browning too fast.",
      "Carefully flip (use a plate to help if needed) and cook the second side for about 5 minutes until golden, crisp, and the chicken is cooked through.",
      "While the pancake cooks, whisk together the soy sauce, rice vinegar, honey, sesame oil, gochugaru, and minced garlic in a small bowl for the dipping sauce.",
      "Slide the pancake onto a cutting board, scatter the scallion curls on top, and cut into squares or wedges. Serve hot with the dipping sauce.",
    ],
    notes: "This is padakjeon — a viral Korean chicken-and-scallion pancake, savory and shallow-fried rather than fluffy. Chicken thigh gives the juiciest result, but tenderloin or breast works if sliced thin. Keep the pancake on the thinner side; it crisps better than a thick one. Some versions add a splash of a neutral 40%+ spirit (like vodka) to the batter to limit gluten development for extra crunch — optional, the alcohol cooks off.",
  },
  {
    id: "demo-52",
    ...
    favorite: false,
    ingredients: [
      { amount: 2, unit: "", name: "bone-in, skin-on chicken thighs" },
      { amount: 2, unit: "tsp", name: "sesame oil (for chicken)" },
      { amount: 0.25, unit: "tsp", name: "salt (for chicken)" },
      { amount: 2, unit: "cup", name: "jasmine rice" },
      { amount: 6, unit: "", name: "garlic cloves, minced or grated (for rice)" },
      { amount: 0.5, unit: "in", name: "ginger, minced or grated (for rice)" },
      { amount: 3, unit: "", name: "green onions, chopped" },
      { amount: 2, unit: "cup", name: "chicken broth (for rice)" },
      { amount: 1, unit: "tsp", name: "chicken bouillon powder" },
      { amount: 0.5, unit: "tsp", name: "turmeric powder (optional)" },
      { amount: 2, unit: "tbsp", name: "neutral oil (for ginger scallion sauce)" },
      { amount: 0.5, unit: "in", name: "ginger, minced (for ginger scallion sauce)" },
      { amount: 1, unit: "", name: "green onion, minced (for ginger scallion sauce)" },
      { amount: 1, unit: "tsp", name: "sesame oil (for ginger scallion sauce)" },
      { amount: 0.25, unit: "tsp", name: "salt, to taste (for ginger scallion sauce)" },
      { amount: 2, unit: "tbsp", name: "sriracha" },
      { amount: 2, unit: "tbsp", name: "sambal" },
      { amount: 6, unit: "", name: "garlic cloves, minced or grated (for chili sauce)" },
      { amount: 0.5, unit: "in", name: "ginger, minced or grated (for chili sauce)" },
      { amount: 1, unit: "tbsp", name: "chicken broth (for chili sauce)" },
      { amount: 1, unit: "tsp", name: "lime juice" },
      { amount: 2, unit: "tsp", name: "sugar" },
      { amount: 1, unit: "", name: "cucumber, sliced (optional topping)" },
      { amount: 1, unit: "", name: "cilantro, to taste (optional topping)" },
    ],
    steps: [
      "Place the chicken thighs in a mixing bowl and season with sesame oil and salt.",
      "Add jasmine rice, garlic, ginger, green onion, chicken broth, chicken bouillon powder, and turmeric powder into your rice cooker bowl.",
      "Place the seasoned chicken thighs on top of the rice.",
      "Run your rice cooker on the white rice setting.",
      "While it cooks, combine the ginger, green onion, and salt in a bowl for the ginger scallion sauce.",
      "Heat the sesame oil and neutral oil in a pan until the oil just starts to shimmer or gives off its first wisp of smoke. Watch closely to avoid flare-ups.",
      "Pour the hot oil into the bowl with the rest of the ginger scallion sauce ingredients and mix.",
      "Combine the garlic, ginger, sambal, sriracha, chicken broth, lime juice, and sugar in a bowl and mix for the chili sauce.",
      "Once the rice cooker finishes, remove the chicken and slice or serve whole. Plate rice with chicken, both sauces, and optional cucumber and cilantro.",
    ],
    notes: "Original source: a TikTok/Instagram recipe by @dougdoesdelicious, republished on Foodie Plus. Ginger amounts convert roughly from '½ inch' pieces — adjust to taste. Watch the oil closely when heating for the ginger scallion sauce; it should just start to shimmer, not smoke heavily.",
  },
  {
    id: "demo-53",
    name: "Canned Tuna Laab",
    category: "Lunch",
    servings: 3,
    prepTime: "5 min",
    cookTime: "5 min",
    favorite: false,
    ingredients: [
      { amount: 10, unit: "oz", name: "canned tuna, drained" },
      { amount: 1, unit: "tbsp", name: "fish sauce" },
      { amount: 2, unit: "", name: "limes, juiced" },
      { amount: 1, unit: "tsp", name: "sugar" },
      { amount: 1, unit: "tbsp", name: "crushed dried Thai chili" },
      { amount: 2, unit: "tbsp", name: "sticky rice" },
      { amount: 3, unit: "", name: "kaffir lime leaves" },
      { amount: 0.33, unit: "", name: "red onion, thinly sliced along the grain" },
      { amount: 1, unit: "", name: "mint leaves, to taste" },
      { amount: 1, unit: "", name: "cilantro, chopped, to taste" },
      { amount: 1, unit: "", name: "green onions, chopped, to taste" },
      { amount: 1, unit: "", name: "sticky rice, lettuce, and cucumbers, for serving" },
    ],
    steps: [
      "Thinly slice the red onion along the grain into thin strips. Optionally soak in cold water for 5 minutes, then drain, to soften the raw bite.",
      "Remove mint leaves from their stems. Finely chop the green onions and cilantro.",
      "In a dry pan over medium heat, toast the sticky rice with the kaffir lime leaves, stirring frequently, until golden brown and fragrant, about 5-7 minutes.",
      ...
      "In a small bowl, mix the fish sauce, lime juice, sugar, and crushed dried chili until the sugar dissolves.",
      "Open and drain the canned tuna. Add it to a mixing bowl with the sliced red onion, green onions, cilantro, and mint.",
      "Pour the sauce over and mix well, then add the toasted rice powder and gently toss to combine.",
      "Plate with fresh lettuce, cabbage leaves, or cucumber slices, and sticky rice on the side. Serve at room temperature.",
    ],
    notes: "Source: Ken Tran, feedthepudge.com — a canned-tuna riff on traditional Lao/Thai laab (larb). Some commenters note the printed directions once referenced minced garlic that wasn't in the ingredient list; garlic is optional and not required for the recipe to work. Toasted rice powder is worth seeking out, but the dish still works without it if using other crunchy accompaniments like lettuce wraps or crackers.",
  },
];

...
const DEFAULT_RECIPES = [
...

  {
    ...
    favorite: false,
    ingredients: [
      { amount: 1, unit: "lb", name: "chicken thighs, cut into bite-size pieces" },
      { amount: 0.5, unit: "tsp", name: "white pepper" },
      { amount: 1.5, unit: "tbsp", name: "garlic, minced" },
      { amount: 1, unit: "tbsp", name: "ginger, minced" },
      { amount: 1, unit: "tbsp", name: "Shaoxing wine" },
      { amount: 2, unit: "tbsp", name: "soy sauce" },
      { amount: 0.75, unit: "cup", name: "potato starch" },
      { amount: 1, unit: "", name: "egg white" },
      { amount: 0, unit: "", name: "cooking oil spray" },
      { amount: 0, unit: "", name: "green onions, for topping" },
      { amount: 1, unit: "tbsp", name: "Korean hot mustard (optional, for sauce)" },
      ...
      { amount: 2, unit: "tbsp", name: "water (for sauce)" },
      { amount: 0.5, unit: "tbsp", name: "lemon juice (for sauce)" },
    ],
    steps: [
      "Marinate the chicken with white pepper, garlic, ginger, Shaoxing wine, soy sauce, and egg white.",
      "Coat each piece of chicken in potato starch.",
      "Air fry at 390°F (200°C) for 13-15 minutes, flipping halfway. Lightly spray with oil before cooking.",
      "While the chicken cooks, mix all sauce ingredients together: Korean hot mustard (if using), wasabi, brown sugar, soy sauce, rice vinegar, water, and lemon juice.",
      "Top the crispy chicken with green onions and the sauce.",
    ],
    notes: "From an Instagram reel — Taiwanese-style popcorn chicken with a wasabi-soy glaze. Recipe as shown makes 1 serving of the sauce amounts listed; scale sauce up if cooking more chicken. Korean hot mustard is optional but adds extra sharpness alongside the wasabi. Toss with the sauce right before serving so the coating stays crisp.",
  },
  {
    id: "demo-43",
    name: "Chinese Turnip Cake (Lo Bak Go)",
    category: "Dim Sum",
    servings: 4,
    prepTime: 30,
    cookTime: 60,
    favorite: false,
    ingredients: [
      { amount: 2, unit: "lb", name: "Chinese turnip (daikon), peeled and shredded" },
      { amount: 8, unit: "oz", name: "regular rice flour" },
      { amount: 1.5, unit: "cup", name: "water" },
      { amount: 1, unit: "oz", name: "dried shrimp, soaked and minced" },
      { amount: 4, unit: "piece", name: "dried shiitake mushrooms, soaked 15-20 min and minced" },
      { amount: 1, unit: "piece", name: "Chinese sausage (lap cheong), minced" },
      { amount: 1.5, unit: "tsp", name: "salt" },
      { amount: 1, unit: "tbsp", name: "vegetable oil" },
      { amount: 1, unit: "tbsp", name: "corn oil" },
      { amount: 1, unit: "tsp", name: "sesame oil" },
      { amount: 2, unit: "clove", name: "garlic, minced" },
      { amount: 2, unit: "tsp", name: "chicken bouillon" },
      { amount: 0.5, unit: "tsp", name: "white pepper" },
    ...
    steps: [
      ...
      "Stir in salt, chicken bouillon, white pepper, and sesame oil. Cover and cook 2-3 more minutes.",
      "Slowly stream in the rice flour slurry while stirring continuously to avoid lumps. Cook 2 minutes until thickened.",
      "Prepare a cake pan lined with parchment and oiled around the rim. Transfer the mixture to the pan, flatten the surface, and spread corn oil on top for shine.",
      "STOVETOP STEAMER: Steam over boiling water for 20 minutes on high heat, then 20 minutes on medium heat (about 40 minutes total), until a chopstick inserted comes out clean.",
      "INSTANT POT: Add 1 cup cold water and a trivet to the inner pot. Place the cake pan on the trivet, seal the lid, and pressure cook on High for 32 minutes, then let it natural release for 20 minutes before venting any remaining pressure.",
      "Sprinkle reserved Chinese sausage on top and cover 30 seconds. Remove from steamer/pot, garnish with green onion, and let cool to room temperature, then refrigerate 4-8 hours before slicing.",
      "Slice into rectangles and pan-fry in oil over medium-high heat, 4-7 minutes per side, until golden and crisp.",
    ],
    notes: "Adapted from madewithlau.com, with dried shiitake mushrooms added alongside the dried shrimp. Instant Pot steam time (32 min + 20 min natural release) sourced from pressurecookrecipes.com — a longer, more reliable timing than a stovetop guess. Chilling before slicing is essential or the cake will fall apart when pan-fried.",
  },
  {
    id: "demo-44",
    ...
    favorite: false,
    ingredients: [
      { amount: 0.75, unit: "lb", name: "pork belly, sliced thin" },
      { amount: 2, unit: "cup", name: "aged/sour napa cabbage kimchi, cut into bite-size pieces" },
      { amount: 0.25, unit: "cup", name: "kimchi juice (from the jar)" },
      { amount: 0.5, unit: "", name: "yellow onion, sliced" },
      { amount: 3, unit: "clove", name: "garlic, minced" },
      { amount: 2, unit: "tbsp", name: "gochugaru (Korean chili flakes)" },
      { amount: 1, unit: "tbsp", name: "gochujang (Korean chili paste)" },
      { amount: 1, unit: "tbsp", name: "soy sauce" },
      { amount: 1, unit: "tsp", name: "sugar" },
      { amount: 1, unit: "tsp", name: "sesame oil" },
      { amount: 2.5, unit: "cup", name: "anchovy stock, chicken broth, or water" },
      { amount: 200, unit: "g", name: "medium-firm tofu, sliced" },
      { amount: 2, unit: "", name: "scallions, cut into 1-inch pieces" },
      { amount: 1, unit: "tbsp", name: "rice wine (mirin or sake), for marinating pork" },
      { amount: 0.25, unit: "tsp", name: "ground black pepper, for marinating pork" },
    ],
    steps: [
      "Toss the pork belly with rice wine and black pepper. Let sit 10-15 minutes while you prep everything else.",
      "Heat sesame oil in a pot over medium-high heat. Add the marinated pork and cook, stirring, until lightly browned and some fat has rendered, about 4-5 minutes.",
      "Add the kimchi and onion to the pot. Cook, stirring occasionally, for 5 minutes until the kimchi is lightly caramelized and fragrant.",
      "Stir in garlic, gochugaru, gochujang, soy sauce, and sugar. Stir-fry for about 1 minute to bloom the garlic and chili.",
      "Pour in the stock/broth/water and kimchi juice. Bring to a boil, then reduce to a steady simmer, cover, and cook for 15-20 minutes until the pork is tender and the broth has deepened in color.",
      "Taste and adjust — more gochugaru for heat, a pinch of sugar if too sour, more kimchi juice if you want it tangier. Gently nestle in the tofu and scatter scallions on top. Simmer 2-3 minutes more without stirring too hard, just until the tofu is heated through.",
    ],
    notes: "USE OLD KIMCHI: Fresh kimchi won't give you enough sour depth — the more fermented/sour your kimchi is, the better this tastes.\n\nBROTH OPTIONS: Anchovy stock (dashima + dried anchovies simmered 15 min) gives the most authentic depth. Low-sodium chicken broth is a solid substitute — you lose some of the briny umami, but the gochugaru, gochujang, and fermented kimchi carry most of the flavor. If using chicken broth, watch the added salt since soy sauce, gochujang, and kimchi juice are already salty; a small splash of fish sauce or a piece of dried kelp simmered in briefly helps close the umami gap. Plain water works in a pinch too.\n\nPROTEIN SWAPS: Pork shoulder works instead of belly (leaner, still tender). Tuna, chicken thigh, or extra tofu also work for a lighter or vegetarian version — use vegetable broth if going vegetarian and make sure your kimchi is vegan.\n\nLEFTOVERS: Tastes even better the next day once the broth has had time to deepen.",
  },
];
